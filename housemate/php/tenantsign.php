...
//let us first confirm that the user entered data into the form
		...
		$sqlstm="INSERT INTO Users (Name,PhoneNum,Email,Password,UType,IdNum) 
		VALUES('$Name','$PhnNum','$Email','$pass1','$type','$UserID')";
		...
		echo "<p>Thanks alot $Name for registering with us. your Account is now working.</br>
		</br> <a href='../index.html'>Back to Login..</a>
		</p>";}
	}else{
		echo "<span><h3>The passwords do not match or they are less
		 than the required password size of 6 charachters</br></br></span>
	 		<a href='../index.html'> Go Back to correct...</a></h3>";
	}
	}}else{
			echo "<span><h3>It seems that the User already exists.</br></br></span>
